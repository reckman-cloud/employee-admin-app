...
module.exports = async function (context, req) {
  ...
  try {
    ...
    const qc = new QueueClient(conn, queue); await qc.createIfNotExists();
    ...
    context.log.error('Health check failed', error?.message || error);
    context.res = { status: 503, headers: { "Content-Type":"application/json; charset=utf-8", ...cors }, body: { ok:false, reason:'queue-connection-failed' } };
  }
};
