...
module.exports = async function (context, req) {
  ...
  try {
    ...
    const storage = storageSnapshot(getConn(), getQueueName());
    context.res = { status: 503, headers: { "Content-Type":"application/json; charset=utf-8", ...cors }, body: { ok:false, reason, storage } };
  }
};
